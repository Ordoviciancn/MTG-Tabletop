...
8. 使用阶段按钮推进回合。
9. 通过点击按钮或拖拽移动牌。
10. 如一方认输，点击“投降”记录本局胜者。
11. 点击“下一局”清理牌桌并进入下一局。
...
- 显示当前第几局、已完成局数、当前先手和最近胜者。
- 可以选择“我先手”或“对手先手”。
- 点击“投降”会将本局胜利记给对手，并更新比分。
- 点击“下一局”会清空公共区域、重置生命和手牌，并进入下一局。
- 投降记录和胜场统计属于公开信息，双方都能看到。
...
- 公开记录：双方都能看到，包括阶段、生命、移动牌、投骰、投降、胜场、聊天等。
